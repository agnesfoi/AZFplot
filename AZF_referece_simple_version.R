...
load("Reference/AZF_plot_Reference_raport.Rdata") # load Rdata reference
...
save.image("Reference/AZF_plot_Reference_raport_new.Rdata") # save new data into .Rdata reference
